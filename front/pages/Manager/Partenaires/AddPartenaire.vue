<template>
            ...
            <v-row class="">
              ...
              <v-col cols="12" sm="6" md="6">
                <v-text-field
                  ...
                  @input="v$.responsable.$touch"
                  :error-messages="v$.responsable.$errors.map((e) => e.$message)"
                ></v-text-field>
              </v-col>
  ...
  const rules = {
    raisonSocial: {
      required: withMessage("Raison Social obligatoire", required),
    },
    ...
    responsable: {
      required: withMessage("responsable obligatoire", required),
    },
    pays: {
      required: withMessage("pays obligatoire", required),
    },
  };
      ...
      setTimeout(async () => {
        try {
          ...
          const response = await axios.post(
            "http://localhost:5252/api/partenaire",
            data
          );
          emit("dataChanged");
