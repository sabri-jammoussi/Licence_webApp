    ...
    <v-layout>
      <v-navigation-drawer v-model="drawer">
        <v-list class="custom-list-margin">
          ...
          <span @click="navigateTo('/users/UserList')">
            <v-list-item prepend-icon="mdi-account" value="home">
              <v-tooltip activator="parent" location="end"
                >Utilisateur</v-tooltip
              >
              <span class="v-list-item__title">Utilisateur</span>
            </v-list-item>
          </span>
          <span @click="navigateTo('/about')">
            <v-list-item prepend-icon="mdi-forum" value="home">
            ...
            <v-card>
              <v-card-text>
                <div class="mx-auto text-center">
                  ...
                  <span
                    @click="navigateTo('/updateUserProfile/CurrentUserPage')"
                  >
